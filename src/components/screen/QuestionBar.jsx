  ...
  return (
    <LargeWindow >
      ...
      <table>
        <tr>
          <td>
            <Button {...getButtonFormatting(QuestionStatus.MARKED)} 
              sx={{maxWidth: '30px', maxHeight: '30px', minWidth: '30px', minHeight: '30px', m: 1}}>1</Button>
            <Typography variant='caption' >Marked</Typography>
          </td>
          <td>
            <Button {...getButtonFormatting(QuestionStatus.NOT_VISITED)}  
              sx={{maxWidth: '30px', maxHeight: '30px', minWidth: '30px', minHeight: '30px', m: 1}}>1</Button>
        ...
        <tr>
          <td>
            <Button {...getButtonFormatting(QuestionStatus.ANSWERED)} 
              sx={{maxWidth: '30px', maxHeight: '30px', minWidth: '30px', minHeight: '30px', mt: 1, mx : 1 }}>1</Button>
            <Typography variant='caption' >Answered</Typography>
          </td>
          <td>
            <Button {...getButtonFormatting(QuestionStatus.NOT_ANSWERED)} 
              sx={{maxWidth: '30px', maxHeight: '30px', minWidth: '30px', minHeight: '30px', mt: 1, mx : 1}}>1</Button>
